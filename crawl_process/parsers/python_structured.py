...
if __name__ == '__main__':
    print(python_query_parse("how do i display records containing specific \n information in sql()?"))
    ...
    print(python_context_parse('How to calculate the v1alue of the sum of squares defined as \n 1^2 + 2^2 + 3^2 + ... +n2 until a user specified sum has been reached sql()'))
    ...
    print(python_code_parse("d = {'x': 0.1, 'y': 2, 'z': 3} \n for key in d: \n  print (key, 'corresponds to', d[key])"))
